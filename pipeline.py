...
#  * @brief Pipeline structure of the code.
#  * @version 1.0
#  * @date 2021-04-13
        ...
        for i in finder_frameset:
            ...
            if len(reduced_face_locations) > 0:
                ...
                if len(face_locations) > 0:
                    print('[INFO]. Face extraction warning : ', i, '- found face in full frame', face_locations)
                    no_face_acc = 0  # reset the no_face_acceleration mode accumulator
                    ...
                    print('[INFO]. Face extraction warning : ',i, '- no face')
                    no_face_acc += 1
                    no_face += 1

        print('[INFO]. Face extraction report of', 'not_found :', not_found)
        print('[INFO]. Face extraction report of', 'no_face :', no_face)
        return 0
...
def compute_accuracy(classifier, filepath, frame_subsample_count = 30):
    '''
